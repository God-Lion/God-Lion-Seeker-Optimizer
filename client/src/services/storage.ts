...
class StorageManager {
  ...
  /**
   * ⚠️ WARNING: This is Base64 ENCODING, NOT encryption!
   * Base64 is easily reversible and provides NO security.
   * 
   * For production encryption, use:
   * - Web Crypto API (window.crypto.subtle)
   * - crypto-js library with AES-256
   * - libsodium.js for modern cryptography
   * 
   * DO NOT use this for sensitive data like passwords or tokens!
   */
  ...
  /**
   * ⚠️ WARNING: This is Base64 DECODING, NOT decryption!
   */
