...
import type { ICategory, IProvider } from 'src/Views/type'
import {
  Avatar,
  Badge,
  Box,
...
export type ICategoryTypeWithAction = ICategory & {
  action?: string
}

const getAvatar = ({ image, name }: Pick<ICategory, 'image' | 'name'>) => {
  if (image)
    return (
      <Avatar
        src={image}
...
const columnHelper = createColumnHelper<ICategoryTypeWithAction>()

const columnDefault: Array<ColumnDef<ICategoryTypeWithAction, any>> = [
