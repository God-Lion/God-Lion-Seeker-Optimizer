...
const projectTable: Array<ProjectListDataType> = [
  {
    id: 1,
    hours: '18:42',
    progressValue: 78,
...
const ProjectListTable = () => {
  ...
  const [data, setData] = React.useState(...[projectTable])
  const [globalFilter, setGlobalFilter] = React.useState('')

  const columns = React.useMemo<ColumnDef<ProjectListDataType, any>[]>(
    () => [
