...
import { InvoiceType } from 'src/fake-db/types/apps/invoiceTypes'
...
const InvoiceListTable = ({ invoiceData }: { invoiceData: InvoiceType[] }) => {
  ...
  const columns = React.useMemo<ColumnDef<InvoiceTypeWithAction, any>[]>(
    () => [
      columnHelper.accessor('id', {
        ...
        cell: ({ row }) => (
          <Typography
            ...
            //   `apps/invoice/preview/${row.original.id}`,
            //   locale as Locale,
            // )}
            to={''}
            color='primary'
            ...
            {/* <OptionMenu
              ...
              options={[
                ...
                },
                {
                  ...
                  href: getLocalizedUrl(
                    `apps/invoice/edit/${row.original.id}`,
                    locale as Locale,
                  ),
                  linkProps: {
                    className: classnames(
